...
13. **Color picker.** Open **Color picker** from the tray menu and confirm it sits directly below **New GIF**.
    ...
    - On a multi-display setup, confirm the magnifier works on each display and that the color is right on a scaled (non-100% DPI) display and on an HDR display.
