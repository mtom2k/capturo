...
17. Right-click the tray and open **Settings…**. Confirm it opens once and refocuses rather than stacking a second window when reopened, that closing it leaves the tray process resident, and that the **Capture** and **GIF** tabs switch. In GIF, verify frame rate, quality, the 0-10 second pre-timer, frame-count visibility, and the GIF shortcut persist after closing and reopening Settings.
