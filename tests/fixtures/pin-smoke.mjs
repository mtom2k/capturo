...
try {
  ...
  console.log('PASS: real Pin toolbar, decoded reveal, always-on-top, opacity, resize, original-resolution clipboard, independent pins, overlay teardown, and Escape close.')
} finally {
